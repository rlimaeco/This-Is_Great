"""
This_Is_Great base module.

This is the principal module of the This_Is_Great project.
...
run `make install` to install the This_Is_Great application.
...
Create a Flask factory here on this file:
    ...
    def create_app():
        ...
        @app.route('/')
        def index():
            return 'Hello World from This_Is_Great!'
