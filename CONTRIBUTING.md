...
This_Is_Great welcomes contributions from the community.
...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/This_Is_Great.git`
- Enter the directory `cd This_Is_Great`
- Add upstream repo `git remote add upstream https://github.com/rochacbruno/This_Is_Great`
